...
const translations = {
  ...
  marquee_8: "Exceptional Quality",
    ...
    privacy_h5_delete: "To request the deletion of your account and all associated data, visit our ",
    privacy_h5_delete_link: "Account Deletion page",

    // Delete Account page
    delete_title: "Delete Your Account",
    delete_intro: "You can request the deletion of your Caffettino account and all associated data directly from within the app, or by contacting us.",
    delete_opt1_title: "Option 1 — Delete from the app",
    delete_opt1_step1: "Open the Caffettino app and sign in.",
    delete_opt1_step2: "Go to the Profile tab.",
    delete_opt1_step3: "Scroll to the bottom and tap \"Delete Account\".",
    delete_opt1_step4: "Confirm the deletion when prompted.",
    delete_opt2_title: "Option 2 — Contact us",
    delete_opt2_intro: "If you are unable to access the app, send an email to request account deletion:",
    delete_opt2_subject: "Subject: Account Deletion Request",
    delete_opt2_note: "Include the email address or phone number associated with your account.",
    delete_data_title: "What data is deleted",
    delete_data_1: "Your profile information (name, email, phone number)",
    delete_data_2: "Your order history",
    delete_data_3: "Your device tokens and location data",
    delete_data_4: "Your account credentials",
    delete_retention_title: "Retention period",
    delete_retention_text: "All personal data is permanently deleted within 30 days of the request. Anonymised order records may be retained for accounting purposes as required by law.",
  ...
  ar: {
    ...
    privacy_h5_delete: "لطلب حذف حسابك وجميع بياناتك المرتبطة به، يرجى زيارة ",
    privacy_h5_delete_link: "صفحة حذف الحساب",

    // Delete Account page
    delete_title: "حذف حسابك",
    delete_intro: "يمكنك طلب حذف حساب Caffettino وجميع بياناتك المرتبطة به مباشرةً من داخل التطبيق، أو عن طريق التواصل معنا.",
    delete_opt1_title: "الخيار الأول — الحذف من التطبيق",
    delete_opt1_step1: "افتح تطبيق Caffettino وسجّل الدخول.",
    delete_opt1_step2: "انتقل إلى صفحة الملف الشخصي.",
    delete_opt1_step3: "مرّر للأسفل واضغط على \"حذف الحساب\".",
    delete_opt1_step4: "أكّد الحذف عند الطلب.",
    delete_opt2_title: "الخيار الثاني — تواصل معنا",
    delete_opt2_intro: "إذا لم تتمكن من الوصول إلى التطبيق، أرسل بريدًا إلكترونيًا لطلب حذف الحساب:",
    delete_opt2_subject: "الموضوع: طلب حذف الحساب",
    delete_opt2_note: "أدرج عنوان البريد الإلكتروني أو رقم الهاتف المرتبط بحسابك.",
    delete_data_title: "البيانات التي يتم حذفها",
    delete_data_1: "معلومات ملفك الشخصي (الاسم، البريد الإلكتروني، رقم الهاتف)",
    delete_data_2: "سجل طلباتك",
    delete_data_3: "رموز جهازك وبيانات الموقع",
    delete_data_4: "بيانات اعتماد حسابك",
    delete_retention_title: "مدة الاحتفاظ",
    delete_retention_text: "يتم حذف جميع البيانات الشخصية نهائيًا خلال 30 يومًا من تاريخ الطلب. قد تُحتفظ بسجلات الطلبات لأغراض محاسبية وفقًا للقانون.",
    delete_back: "→ العودة إلى الرئيسية",
